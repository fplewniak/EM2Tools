...
class GetSetAction(unittest.TestCase):
    ...
    @staticmethod
    def test_fromfile():
        assert ArgparseEM2.GetSet.arg2set(['data/list_1columnA.txt']) == {'Item1', 'Item2', 'Item3'}

    @staticmethod
    def test_from2files():
        assert ArgparseEM2.GetSet.arg2set(
            ['data/list_1columnA.txt', 'data/list_1columnB.txt']) == {'Item1', 'Item2', 'Item3', 'Item4', 'Item5'}
    ...
    @staticmethod
    def test_from_one():
        assert ArgparseEM2.GetSet.arg2set(['a']) == {'a'}

    @staticmethod
    def test_fromlist():
        assert ArgparseEM2.GetSet.arg2set(['a', 'b', 'c']) == {'a', 'b', 'c'}

    @staticmethod
    def test_fromlist_redundant():
        assert ArgparseEM2.GetSet.arg2set(['a', 'b', 'c', 'a']) == {'a', 'b', 'c'}

    @staticmethod
    def test_fromfile_and_list():
        assert ArgparseEM2.GetSet.arg2set(['data/list_1columnA.txt', 'a', 'b', 'c']) == {'Item1', 'Item2', 'Item3',
                                                                                         'a', 'b', 'c'}

    @staticmethod
    def test_fromfile_and_list_redundant():
        assert ArgparseEM2.GetSet.arg2set(['data/list_1columnA.txt', 'a', 'Item2', 'c']) == {'Item1', 'Item2', 'Item3',
                                                                                             'a', 'c'}

    @staticmethod
    def test_none():
        assert ArgparseEM2.GetSet.arg2set(None) == set()
